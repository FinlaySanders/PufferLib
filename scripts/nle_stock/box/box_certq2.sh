...
cd /workspace/PufferLib; Q=/workspace/sweeps/certq/jobs2.txt; R=/workspace/sweeps/certq/results.log; mkdir -p /workspace/sweeps/certq; : > $Q
...
echo "stock stock2b_s11 $CH 11 0" >> $Q; echo "stock stock2b_s7 $CH 7 0" >> $Q; echo "stock stock4b_s7 $B4 7 0" >> $Q; echo "stock stockpub301_s7 $P1 7 0" >> $Q
echo "$(date +%T) requeued $(wc -l < $Q) runs (ulimit fix, real weights)" >> $R
...
ulimit -n 65536; for g in 2 3 4 5 6 7; do worker $g & done; wait
